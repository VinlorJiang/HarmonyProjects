...
/***/ "../../../../../../../../Documents/learning/Harmony/communication_bluetooth-master/test/example/bluetoothtest/entry/src/main/ets/Component/componentConfig.ets":
/*!*********************************************************************************************************************************************************************!*\
  !*** ../../../../../../../../Documents/learning/Harmony/communication_bluetooth-master/test/example/bluetoothtest/entry/src/main/ets/Component/componentConfig.ets ***!
  \*********************************************************************************************************************************************************************/
...
/***/ "../../../../../../../../Documents/learning/Harmony/communication_bluetooth-master/test/example/bluetoothtest/entry/src/main/ets/Component/imageAnimatorComponent.ets":
/*!****************************************************************************************************************************************************************************!*\
  !*** ../../../../../../../../Documents/learning/Harmony/communication_bluetooth-master/test/example/bluetoothtest/entry/src/main/ets/Component/imageAnimatorComponent.ets ***!
  \****************************************************************************************************************************************************************************/
 ...
 * limitations under the License.
 */
const componentConfig_1 = __importDefault(__webpack_require__(/*! ./componentConfig */ "../../../../../../../../Documents/learning/Harmony/communication_bluetooth-master/test/example/bluetoothtest/entry/src/main/ets/Component/componentConfig.ets"));
...
/***/ "../../../../../../../../Documents/learning/Harmony/communication_bluetooth-master/test/example/bluetoothtest/entry/src/main/ets/MainAbility/pages/subManualApiTest/subBrTest/deviceFound.ets?entry":
/*!**********************************************************************************************************************************************************************************************************!*\
  !*** ../../../../../../../../Documents/learning/Harmony/communication_bluetooth-master/test/example/bluetoothtest/entry/src/main/ets/MainAbility/pages/subManualApiTest/subBrTest/deviceFound.ets?entry ***!
  \**********************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const BluetoothModel_1 = __webpack_require__(/*! ../../../model/BluetoothModel */ "../../../../../../../../Documents/learning/Harmony/communication_bluetooth-master/test/example/bluetoothtest/entry/src/main/ets/MainAbility/model/BluetoothModel.ts");
const imageAnimatorComponent_1 = __importDefault(__webpack_require__(/*! ../../../../Component/imageAnimatorComponent */ "../../../../../../../../Documents/learning/Harmony/communication_bluetooth-master/test/example/bluetoothtest/entry/src/main/ets/Component/imageAnimatorComponent.ets"));
...
class deviceFound extends View {
    ...
    render() {
        ...
        Column.padding({
            ...
            bottom: { "id": 16777384, "type": 10002, params: [] }
        });
        Column.width(ConfigData_1.default.WH_100_100);
        Column.height(ConfigData_1.default.WH_100_100);
        Column.useSizeType({
...
class PairedDeviceComponent extends View {
    ...
    render() {
        ...
        if (this.pairedDevices && this.pairedDevices.length > 0) {
            ...
            Row.padding({
                left: { "id": 16777381, "type": 10002, params: [] },
                top: { "id": 16777376, "type": 10002, params: [] },
                bottom: { "id": 16777394, "type": 10002, params: [] }
            });
            ...
            List.divider({
                strokeWidth: 1,
                color: { "id": 16777304, "type": 10001, params: [] },
                startMargin: { "id": 16777524, "type": 10002, params: [] },
                endMargin: { "id": 16777481, "type": 10002, params: [] }
            });
            List.backgroundColor({ "id": 16777322, "type": 10001, params: [] });
            List.borderRadius({ "id": 16777437, "type": 10002, params: [] });
            // paired devices list
            ForEach.create("6", this, ObservedObject.GetRawObject(this.pairedDevices), (item, index) => {
                ListItem.create();
                Row.create();
                Row.width(ConfigData_1.default.WH_100_100);
                Row.borderRadius({ "id": 16777437, "type": 10002, params: [] });
                Row.padding({ "id": 16777386, "type": 10002, params: [] });
                Row.backgroundColor({ "id": 16777322, "type": 10001, params: [] });
                Row.onClick(() => {
    ...
    showDisconnectDialog(deviceName, callback) {
        AlertDialog.show({
            title: { "id": 16777241, "type": 10003, params: [] },
            message: { "id": 16777242, "type": 10003, params: [deviceName] },
            primaryButton: {
            ...
            secondaryButton: {
                value: { "id": 16777263, "type": 10003, params: [] },
                action: () => {
    ...
    render() {
        ...
        if (earlierCreatedChild_7 == undefined) {
            View.create(new imageAnimatorComponent_1.default("7", this, {
                imageWidth: { "id": 16777517, "type": 10002, params: [] },
                imageHeight: { "id": 16777517, "type": 10002, params: [] }
            }));
        }
        else {
...
class AvailableDeviceComponent extends View {
    ...
    render() {
        ...
        if (this.availableDevices && this.availableDevices.length >= 1) {
            ...
            Row.create();
            // Scanning...
            Text.create({ "id": 16777284, "type": 10003, params: [] });
            // Scanning...
...
function getConnectionStateText(device) {
    ...
    switch (device.connectionState) {
        ...
        case BluetoothModel_1.DeviceState.STATE_CONNECTING:
            stateText = { "id": 16777251, "type": 10003, params: [] };
            break;
        case BluetoothModel_1.DeviceState.STATE_CONNECTED:
            if (device.deviceType === BluetoothModel_1.DeviceType.HEADPHONE) {
                stateText = { "id": 16777250, "type": 10003, params: [] };
            }
            else {
                stateText = null;
            }
        ...
        case BluetoothModel_1.DeviceState.STATE_DISCONNECTING:
            stateText = { "id": 16777252, "type": 10003, params: [] };
            break;
        case BluetoothModel_1.DeviceState.STATE_PAIRING:
            stateText = { "id": 16777253, "type": 10003, params: [] };
            break;
    }
    return stateText;
}
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["commons"], () => (__webpack_require__("../../../../../../../../Documents/learning/Harmony/communication_bluetooth-master/test/example/bluetoothtest/entry/src/main/ets/MainAbility/pages/subManualApiTest/subBrTest/deviceFound.ets?entry")))
