...
/***/ "../../../../../../../../Documents/learning/Harmony/communication_bluetooth-master/test/example/bluetoothtest/entry/src/main/ets/MainAbility/pages/subAutoTest/subSppAutoTest/sppClientAutoTest.ets?entry":
/*!****************************************************************************************************************************************************************************************************************!*\
  !*** ../../../../../../../../Documents/learning/Harmony/communication_bluetooth-master/test/example/bluetoothtest/entry/src/main/ets/MainAbility/pages/subAutoTest/subSppAutoTest/sppClientAutoTest.ets?entry ***!
  \****************************************************************************************************************************************************************************************************************/
...
__webpack_require__(/*! ../../../model/sppClientInterface */ "../../../../../../../../Documents/learning/Harmony/communication_bluetooth-master/test/example/bluetoothtest/entry/src/main/ets/MainAbility/model/sppClientInterface.ets");
var _system_prompt_1  = isSystemplugin('prompt', 'system') ? globalThis.systemplugin.prompt : globalThis.requireNapi('prompt');
class SppClientAutoTest extends View {
    constructor(compilerAssignedUniqueChildId, parent, params) {
        super(compilerAssignedUniqueChildId, parent);
        this.__message = new ObservedPropertySimple('SppClientAutoTest', this, "message");
        ...
        this.__sppClientAutoTestMessage = AppStorage.GetOrCreate().setAndLink("sppClientAutoTestMessage", "", this);
    ...
    aboutToBeDeleted() {
        ...
        this.__sppClientAutoTestMessage.aboutToBeDeleted();
    ...
    get sppClientAutoTestMessage() {
        return this.__sppClientAutoTestMessage.get();
    }
    set sppClientAutoTestMessage(newValue) {
        this.__sppClientAutoTestMessage.set(newValue);
    }
    aboutToAppear() {
    ...
    render() {
        ...
        if (earlierCreatedChild_4 == undefined) {
            View.create(new autoContentTable_1.AutoContentTable("4", this, {
                testItem: this.testItem,
                autoItems: autoTestDataModels_1.initSppClientAutoData(),
        ...
        Button.onClick((event) => {
            ...
            let Interface = autoTestDataModels_1.SppClientAutoTestCase.map(i => {
            ...
            async function forLoop() {
                for (let m = 0; m < Interface.length; m++) {
                    sppClientAutoTestMessage += autoTestDataModels_1.SppClientAutoTestCase[m]["api"](...Interface[m].para) + "\n";
                    self.changeIndex = m;
                    await sleep(0.5);
                    AppStorage.SetOrCreate("sppClientAutoTestMessage", sppClientAutoTestMessage);
                }
...
loadDocument(new SppClientAutoTest("1", undefined, {}));
...
/******/ 		var installedChunks = {
/******/ 			"./pages/subAutoTest/subSppAutoTest/sppClientAutoTest": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["commons"], () => (__webpack_require__("../../../../../../../../Documents/learning/Harmony/communication_bluetooth-master/test/example/bluetoothtest/entry/src/main/ets/MainAbility/pages/subAutoTest/subSppAutoTest/sppClientAutoTest.ets?entry")))
/******/ 	__webpack_exports__ = __webpack_require__.O(__webpack_exports__);
/******/ 	_78b3af9a3d4590e7047044e12e71f107 = __webpack_exports__;
/******/ 	
/******/ })()
;
//# sourceMappingURL=sppClientAutoTest.js.map