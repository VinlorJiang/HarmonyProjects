...
/***/ "../../../../../../../../Documents/learning/Harmony/communication_bluetooth-master/test/example/bluetoothtest/entry/src/main/ets/MainAbility/pages/subAutoTest/subProfileAutoTest/panNetworkAutoTest.ets?entry":
/*!*********************************************************************************************************************************************************************************************************************!*\
  !*** ../../../../../../../../Documents/learning/Harmony/communication_bluetooth-master/test/example/bluetoothtest/entry/src/main/ets/MainAbility/pages/subAutoTest/subProfileAutoTest/panNetworkAutoTest.ets?entry ***!
  \*********************************************************************************************************************************************************************************************************************/
...
class PanNetworkAutoTest extends View {
    constructor(compilerAssignedUniqueChildId, parent, params) {
        super(compilerAssignedUniqueChildId, parent);
        this.__message = new ObservedPropertySimple('PanNetworkAutoTest', this, "message");
        ...
        this.__PanNetworkProfileAutoTestMessage = AppStorage.GetOrCreate().setAndLink("PanNetworkProfileAutoTestMessage", "", this);
    ...
    aboutToBeDeleted() {
        ...
        this.__PanNetworkProfileAutoTestMessage.aboutToBeDeleted();
    ...
    get PanNetworkProfileAutoTestMessage() {
        return this.__PanNetworkProfileAutoTestMessage.get();
    }
    set PanNetworkProfileAutoTestMessage(newValue) {
        this.__PanNetworkProfileAutoTestMessage.set(newValue);
    }
    render() {
        Column.create();
        ...
        if (earlierCreatedChild_4 == undefined) {
            View.create(new autoContentTable_1.AutoContentTable("4", this, {
                testItem: this.testItem,
                autoItems: autoTestDataModels_1.initPanNetworkProfileAutoData(),
        ...
        ListItem.create();
        Text.create("log:" + "\n" + this.PanNetworkProfileAutoTestMessage);
        Text.fontSize("17vp");
        ...
        Button.onClick((event) => {
            ...
            let self = this;
            let PanNetworkProfileAutoTestMessage = "";
            ...
            let Interface = autoTestDataModels_1.PanNetworkProfileAutoTestCase.map(i => {
            ...
            //            PanNetworkProfileAutoTestMessage += PanNetworkProfileAutoTestCase[index]["api"](...i.para) + "\n"
            //            sleep(0.5)//等500ms
            //            AppStorage.SetOrCreate("PanNetworkProfileAutoTestMessage",PanNetworkProfileAutoTestMessage)
            //            //干些事情，刷新@state @prop
            //          })
            async function forLoop() {
                for (let m = 0; m < Interface.length; m++) {
                    PanNetworkProfileAutoTestMessage += autoTestDataModels_1.PanNetworkProfileAutoTestCase[m]["api"](...Interface[m].para) + "\n";
                    self.changeIndex = m;
                    await sleep(0.5);
                    AppStorage.SetOrCreate("PanNetworkProfileAutoTestMessage", PanNetworkProfileAutoTestMessage);
                }
...
loadDocument(new PanNetworkAutoTest("1", undefined, {}));
...
/******/ 		var installedChunks = {
/******/ 			"./pages/subAutoTest/subProfileAutoTest/panNetworkAutoTest": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["commons"], () => (__webpack_require__("../../../../../../../../Documents/learning/Harmony/communication_bluetooth-master/test/example/bluetoothtest/entry/src/main/ets/MainAbility/pages/subAutoTest/subProfileAutoTest/panNetworkAutoTest.ets?entry")))
/******/ 	__webpack_exports__ = __webpack_require__.O(__webpack_exports__);
/******/ 	_78b3af9a3d4590e7047044e12e71f107 = __webpack_exports__;
/******/ 	
/******/ })()
;
//# sourceMappingURL=panNetworkAutoTest.js.map