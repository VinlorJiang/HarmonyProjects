...
/***/ "../../../../../../../../Documents/learning/Harmony/communication_bluetooth-master/test/example/bluetoothtest/entry/src/main/ets/MainAbility/pages/subAutoTest/subSppAutoTest/sppServerAutoTest.ets?entry":
/*!****************************************************************************************************************************************************************************************************************!*\
  !*** ../../../../../../../../Documents/learning/Harmony/communication_bluetooth-master/test/example/bluetoothtest/entry/src/main/ets/MainAbility/pages/subAutoTest/subSppAutoTest/sppServerAutoTest.ets?entry ***!
  \****************************************************************************************************************************************************************************************************************/
...
__webpack_require__(/*! ../../../model/sppServerInterface */ "../../../../../../../../Documents/learning/Harmony/communication_bluetooth-master/test/example/bluetoothtest/entry/src/main/ets/MainAbility/model/sppServerInterface.ets");
__webpack_require__(/*! ../../../model/brInterface */ "../../../../../../../../Documents/learning/Harmony/communication_bluetooth-master/test/example/bluetoothtest/entry/src/main/ets/MainAbility/model/brInterface.ets");
...
class SppServerAutoTest extends View {
    constructor(compilerAssignedUniqueChildId, parent, params) {
        ...
        this.__message = new ObservedPropertySimple('SppServerAutoTest', this, "message");
        ...
        this.__sppServerAutoTestMessage = AppStorage.GetOrCreate().setAndLink("sppServerAutoTestMessage", "", this);
    ...
    aboutToBeDeleted() {
        ...
        this.__sppServerAutoTestMessage.aboutToBeDeleted();
    ...
    get sppServerAutoTestMessage() {
        return this.__sppServerAutoTestMessage.get();
    }
    set sppServerAutoTestMessage(newValue) {
        this.__sppServerAutoTestMessage.set(newValue);
    }
    aboutToAppear() {
        ...
        AppStorage.SetOrCreate('writeData', "111111");
    }
    render() {
        Column.create();
        ...
        if (earlierCreatedChild_4 == undefined) {
            View.create(new autoContentTable_1.AutoContentTable("4", this, {
                testItem: this.testItem,
                autoItems: autoTestDataModels_1.initSppServerAutoData(),
        ...
        Button.onClick((event) => {
            ...
            let Interface = autoTestDataModels_1.SppServerAutoTestCase.map(i => {
            ...
            //            sppServerAutoTestMessage += SppServerAutoTestCase[index]["api"](...i.para) + "\n"
            //            sleep(0.5)//等500ms
            //            AppStorage.SetOrCreate("sppServerAutoTestMessage",sppServerAutoTestMessage)
            //            //干些事情，刷新@state @prop
            //          })
            async function forLoop() {
                for (let m = 0; m < Interface.length; m++) {
                    sppServerAutoTestMessage += autoTestDataModels_1.SppServerAutoTestCase[m]["api"](...Interface[m].para) + "\n";
                    self.changeIndex = m;
                    await sleep(0.5);
                    AppStorage.SetOrCreate("sppServerAutoTestMessage", sppServerAutoTestMessage);
                }
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["commons"], () => (__webpack_require__("../../../../../../../../Documents/learning/Harmony/communication_bluetooth-master/test/example/bluetoothtest/entry/src/main/ets/MainAbility/pages/subAutoTest/subSppAutoTest/sppServerAutoTest.ets?entry")))
