...
/***/ "../../../../../../../../Documents/learning/Harmony/communication_bluetooth-master/test/example/bluetoothtest/entry/src/main/ets/MainAbility/pages/subProfileTest/panNetworkProfileTest.ets?entry":
/*!********************************************************************************************************************************************************************************************************!*\
  !*** ../../../../../../../../Documents/learning/Harmony/communication_bluetooth-master/test/example/bluetoothtest/entry/src/main/ets/MainAbility/pages/subProfileTest/panNetworkProfileTest.ets?entry ***!
  \********************************************************************************************************************************************************************************************************/
...
class Index extends View {
    constructor(compilerAssignedUniqueChildId, parent, params) {
        ...
        this.__panMessage = AppStorage.GetOrCreate().setAndLink("textMessage", "", this);
        ...
        this.__title = new ObservedPropertyObject({ "id": 16777279, "type": 10003, params: [] }, this, "title");
    ...
    aboutToBeDeleted() {
        ...
        this.__panMessage.aboutToBeDeleted();
    ...
    get panMessage() {
        return this.__panMessage.get();
    }
    set panMessage(newValue) {
        this.__panMessage.set(newValue);
    }
    get isConnection() {
    ...
    render() {
        ...
        Column.width("88%");
        Column.height(90);
        Text.create("接口调用结果： " + this.panMessage);
        Text.fontSize("17vp");
        ...
        if (earlierCreatedChild_4 == undefined) {
            View.create(new contentTable_1.ContentTable("4", this, { apiItems: testDataModels_1.initPanNetworkProfileApiData() }));
        }
        else {
...
/******/ 		var installedChunks = {
/******/ 			"./pages/subProfileTest/panNetworkProfileTest": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["commons"], () => (__webpack_require__("../../../../../../../../Documents/learning/Harmony/communication_bluetooth-master/test/example/bluetoothtest/entry/src/main/ets/MainAbility/pages/subProfileTest/panNetworkProfileTest.ets?entry")))
