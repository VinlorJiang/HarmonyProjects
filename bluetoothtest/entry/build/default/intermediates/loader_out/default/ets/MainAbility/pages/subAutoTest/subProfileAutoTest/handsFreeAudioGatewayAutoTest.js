...
/***/ "../../../../../../../../Documents/learning/Harmony/communication_bluetooth-master/test/example/bluetoothtest/entry/src/main/ets/MainAbility/pages/subAutoTest/subProfileAutoTest/handsFreeAudioGatewayAutoTest.ets?entry":
/*!********************************************************************************************************************************************************************************************************************************!*\
  !*** ../../../../../../../../Documents/learning/Harmony/communication_bluetooth-master/test/example/bluetoothtest/entry/src/main/ets/MainAbility/pages/subAutoTest/subProfileAutoTest/handsFreeAudioGatewayAutoTest.ets?entry ***!
  \********************************************************************************************************************************************************************************************************************************/
...
class HandsFreeAudioGatewayAutoTest extends View {
    constructor(compilerAssignedUniqueChildId, parent, params) {
        super(compilerAssignedUniqueChildId, parent);
        this.__message = new ObservedPropertySimple('HandsFreeAudioGatewayAutoTest', this, "message");
        ...
        this.__hfpAutoTestMessage = AppStorage.GetOrCreate().setAndLink("hfpAutoTestMessage", "", this);
    ...
    aboutToBeDeleted() {
        ...
        this.__hfpAutoTestMessage.aboutToBeDeleted();
    ...
    get hfpAutoTestMessage() {
        return this.__hfpAutoTestMessage.get();
    }
    set hfpAutoTestMessage(newValue) {
        this.__hfpAutoTestMessage.set(newValue);
    }
    render() {
        Column.create();
        ...
        if (earlierCreatedChild_4 == undefined) {
            View.create(new autoContentTable_1.AutoContentTable("4", this, {
                testItem: this.testItem,
                autoItems: autoTestDataModels_1.initHandsFreeAudioGatewayProfileAutoData(),
        ...
        Button.onClick((event) => {
            ...
            let Interface = autoTestDataModels_1.HandsFreeAudioGatewayProfileAutoTestCase.map(i => {
            ...
            //            hfpAutoTestMessage += HandsFreeAudioGatewayProfileAutoTestCase[index]["api"](...i.para) + "\n"
            //            sleep(0.5)//等500ms
            //            AppStorage.SetOrCreate("hfpAutoTestMessage",hfpAutoTestMessage)
            //          })
            async function forLoop() {
                for (let m = 0; m < Interface.length; m++) {
                    hfpAutoTestMessage += autoTestDataModels_1.HandsFreeAudioGatewayProfileAutoTestCase[m]["api"](...Interface[m].para) + "\n";
                    self.changeIndex = m;
                    await sleep(0.5);
                    AppStorage.SetOrCreate("hfpAutoTestMessage", hfpAutoTestMessage);
                }
...
loadDocument(new HandsFreeAudioGatewayAutoTest("1", undefined, {}));
...
/******/ 		var installedChunks = {
/******/ 			"./pages/subAutoTest/subProfileAutoTest/handsFreeAudioGatewayAutoTest": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["commons"], () => (__webpack_require__("../../../../../../../../Documents/learning/Harmony/communication_bluetooth-master/test/example/bluetoothtest/entry/src/main/ets/MainAbility/pages/subAutoTest/subProfileAutoTest/handsFreeAudioGatewayAutoTest.ets?entry")))
/******/ 	__webpack_exports__ = __webpack_require__.O(__webpack_exports__);
/******/ 	_78b3af9a3d4590e7047044e12e71f107 = __webpack_exports__;
/******/ 	
/******/ })()
;
//# sourceMappingURL=handsFreeAudioGatewayAutoTest.js.map