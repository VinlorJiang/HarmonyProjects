...
/***/ "../../../../../../../../Documents/learning/Harmony/communication_bluetooth-master/test/example/bluetoothtest/entry/src/main/ets/MainAbility/pages/subProfileTest/hidHostProfileTest.ets?entry":
/*!*****************************************************************************************************************************************************************************************************!*\
  !*** ../../../../../../../../Documents/learning/Harmony/communication_bluetooth-master/test/example/bluetoothtest/entry/src/main/ets/MainAbility/pages/subProfileTest/hidHostProfileTest.ets?entry ***!
  \*****************************************************************************************************************************************************************************************************/
...
class Index extends View {
    constructor(compilerAssignedUniqueChildId, parent, params) {
        ...
        this.__hidHostMessage = AppStorage.GetOrCreate().setAndLink("textMessage", "", this);
        ...
        this.__title = new ObservedPropertyObject({ "id": 16777272, "type": 10003, params: [] }, this, "title");
    ...
    aboutToBeDeleted() {
        ...
        this.__hidHostMessage.aboutToBeDeleted();
    ...
    get hidHostMessage() {
        return this.__hidHostMessage.get();
    }
    set hidHostMessage(newValue) {
        this.__hidHostMessage.set(newValue);
    }
    get isConnection() {
    ...
    render() {
        ...
        Column.width("88%");
        Text.create("接口调用结果： " + this.hidHostMessage);
        Text.fontSize("17vp");
        ...
        if (earlierCreatedChild_4 == undefined) {
            View.create(new contentTable_1.ContentTable("4", this, { apiItems: testDataModels_1.initHitHostProfileApiData() }));
        }
        else {
            earlierCreatedChild_4.updateWithValueParams({
                apiItems: testDataModels_1.initHitHostProfileApiData()
            });
    ...
    onPageShow() {
        ...
        this.hasProfile = btProfileModel_1.default.hasProfile(btProfileModel_1.default.PROFILE_HID_HOST);
...
/******/ 		var installedChunks = {
/******/ 			"./pages/subProfileTest/hidHostProfileTest": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["commons"], () => (__webpack_require__("../../../../../../../../Documents/learning/Harmony/communication_bluetooth-master/test/example/bluetoothtest/entry/src/main/ets/MainAbility/pages/subProfileTest/hidHostProfileTest.ets?entry")))
/******/ 	__webpack_exports__ = __webpack_require__.O(__webpack_exports__);
/******/ 	_78b3af9a3d4590e7047044e12e71f107 = __webpack_exports__;
/******/ 	
/******/ })()
;
//# sourceMappingURL=hidHostProfileTest.js.map