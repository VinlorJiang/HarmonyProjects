...
/***/ "../../../../../../../../Documents/learning/Harmony/communication_bluetooth-master/test/example/bluetoothtest/entry/src/main/ets/MainAbility/pages/subAutoTest/subProfileAutoTest/hitHostAutoTest.ets?entry":
/*!******************************************************************************************************************************************************************************************************************!*\
  !*** ../../../../../../../../Documents/learning/Harmony/communication_bluetooth-master/test/example/bluetoothtest/entry/src/main/ets/MainAbility/pages/subAutoTest/subProfileAutoTest/hitHostAutoTest.ets?entry ***!
  \******************************************************************************************************************************************************************************************************************/
...
class HitHostAutoTest extends View {
    constructor(compilerAssignedUniqueChildId, parent, params) {
        super(compilerAssignedUniqueChildId, parent);
        this.__message = new ObservedPropertySimple('HitHostAutoTest', this, "message");
        ...
        this.__hidHostProfileAutoTestMessage = AppStorage.GetOrCreate().setAndLink("hidHostProfileAutoTestMessage", "", this);
    ...
    aboutToBeDeleted() {
        ...
        this.__hidHostProfileAutoTestMessage.aboutToBeDeleted();
    ...
    get hidHostProfileAutoTestMessage() {
        return this.__hidHostProfileAutoTestMessage.get();
    }
    set hidHostProfileAutoTestMessage(newValue) {
        this.__hidHostProfileAutoTestMessage.set(newValue);
    }
    render() {
        Column.create();
        ...
        if (earlierCreatedChild_4 == undefined) {
            View.create(new autoContentTable_1.AutoContentTable("4", this, {
                testItem: this.testItem,
                autoItems: autoTestDataModels_1.initHitHostProfileAutoData(),
        ...
        ListItem.create();
        Text.create("log:" + "\n" + this.hidHostProfileAutoTestMessage);
        Text.fontSize("17vp");
        ...
        Button.onClick((event) => {
            ...
            let self = this;
            let hidHostProfileAutoTestMessage = "";
            ...
            let Interface = autoTestDataModels_1.HitHostProfileAutoTestCase.map(i => {
            ...
            //            hidHostProfileAutoTestMessage += HitHostProfileAutoTestCase[index]["api"](...i.para) + "\n"
            //            sleep(0.5)//等500ms
            //            AppStorage.SetOrCreate("hidHostProfileAutoTestMessage",hidHostProfileAutoTestMessage)
            //            //干些事情，刷新@state @prop
            //          })
            async function forLoop() {
                for (let m = 0; m < Interface.length; m++) {
                    hidHostProfileAutoTestMessage += autoTestDataModels_1.HitHostProfileAutoTestCase[m]["api"](...Interface[m].para) + "\n";
                    self.changeIndex = m;
                    await sleep(0.5);
                    AppStorage.SetOrCreate("hidHostProfileAutoTestMessage", hidHostProfileAutoTestMessage);
                }
...
loadDocument(new HitHostAutoTest("1", undefined, {}));
...
/******/ 		var installedChunks = {
/******/ 			"./pages/subAutoTest/subProfileAutoTest/hitHostAutoTest": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["commons"], () => (__webpack_require__("../../../../../../../../Documents/learning/Harmony/communication_bluetooth-master/test/example/bluetoothtest/entry/src/main/ets/MainAbility/pages/subAutoTest/subProfileAutoTest/hitHostAutoTest.ets?entry")))
/******/ 	__webpack_exports__ = __webpack_require__.O(__webpack_exports__);
/******/ 	_78b3af9a3d4590e7047044e12e71f107 = __webpack_exports__;
/******/ 	
/******/ })()
;
//# sourceMappingURL=hitHostAutoTest.js.map