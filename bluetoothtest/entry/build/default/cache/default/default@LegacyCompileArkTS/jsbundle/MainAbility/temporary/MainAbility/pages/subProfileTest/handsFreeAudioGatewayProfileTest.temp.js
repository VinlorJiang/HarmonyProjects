...
/***/ "../../../../../../../../Documents/learning/Harmony/communication_bluetooth-master/test/example/bluetoothtest/entry/src/main/ets/MainAbility/pages/subProfileTest/handsFreeAudioGatewayProfileTest.ets?entry":
/*!*******************************************************************************************************************************************************************************************************************!*\
  !*** ../../../../../../../../Documents/learning/Harmony/communication_bluetooth-master/test/example/bluetoothtest/entry/src/main/ets/MainAbility/pages/subProfileTest/handsFreeAudioGatewayProfileTest.ets?entry ***!
  \*******************************************************************************************************************************************************************************************************************/
...
class Index extends View {
    constructor(compilerAssignedUniqueChildId, parent, params) {
        ...
        this.__hfpMessage = AppStorage.GetOrCreate().setAndLink("textMessage", "", this);
    ...
    aboutToBeDeleted() {
        ...
        this.__hfpMessage.aboutToBeDeleted();
    ...
    get hfpMessage() {
        return this.__hfpMessage.get();
    }
    set hfpMessage(newValue) {
        this.__hfpMessage.set(newValue);
    }
    get isConnection() {
    ...
    render() {
        ...
        Column.width("88%");
        Text.create("接口调用结果： " + this.hfpMessage);
        Text.fontSize("17vp");
        ...
        if (earlierCreatedChild_4 == undefined) {
            View.create(new contentTable_1.ContentTable("4", this, { apiItems: testDataModels_1.initHandsFreeAudioGatewayProfileApiData() }));
        }
        else {
            earlierCreatedChild_4.updateWithValueParams({
                apiItems: testDataModels_1.initHandsFreeAudioGatewayProfileApiData()
            });
    ...
    onPageShow() {
        ...
        this.hasProfile = btProfileModel_1.default.hasProfile(btProfileModel_1.default.PROFILE_HANDS_FREE_AUDIO_GATEWAY);
...
/******/ 		var installedChunks = {
/******/ 			"./pages/subProfileTest/handsFreeAudioGatewayProfileTest": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["commons"], () => (__webpack_require__("../../../../../../../../Documents/learning/Harmony/communication_bluetooth-master/test/example/bluetoothtest/entry/src/main/ets/MainAbility/pages/subProfileTest/handsFreeAudioGatewayProfileTest.ets?entry")))
/******/ 	__webpack_exports__ = __webpack_require__.O(__webpack_exports__);
/******/ 	_78b3af9a3d4590e7047044e12e71f107 = __webpack_exports__;
/******/ 	
/******/ })()
;
//# sourceMappingURL=handsFreeAudioGatewayProfileTest.js.map