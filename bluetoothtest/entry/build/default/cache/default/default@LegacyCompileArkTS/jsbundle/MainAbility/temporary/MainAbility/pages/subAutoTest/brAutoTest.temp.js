...
/***/ "../../../../../../../../Documents/learning/Harmony/communication_bluetooth-master/test/example/bluetoothtest/entry/src/main/ets/MainAbility/pages/subAutoTest/brAutoTest.ets?entry":
/*!******************************************************************************************************************************************************************************************!*\
  !*** ../../../../../../../../Documents/learning/Harmony/communication_bluetooth-master/test/example/bluetoothtest/entry/src/main/ets/MainAbility/pages/subAutoTest/brAutoTest.ets?entry ***!
  \******************************************************************************************************************************************************************************************/
...
__webpack_require__(/*! ../../model/BluetoothModel */ "../../../../../../../../Documents/learning/Harmony/communication_bluetooth-master/test/example/bluetoothtest/entry/src/main/ets/MainAbility/model/BluetoothModel.ts");
...
class BrAutoTest extends View {
    constructor(compilerAssignedUniqueChildId, parent, params) {
        ...
        , this, "changeIndex");
        this.__brAutoTestMessage = AppStorage.GetOrCreate().setAndLink("brAutoTestMessage", "", this);
    ...
    aboutToBeDeleted() {
        ...
        this.__brAutoTestMessage.aboutToBeDeleted();
    ...
    get brAutoTestMessage() {
        return this.__brAutoTestMessage.get();
    }
    set brAutoTestMessage(newValue) {
        this.__brAutoTestMessage.set(newValue);
    }
    render() {
        Column.create();
        ...
        if (earlierCreatedChild_4 == undefined) {
            View.create(new autoContentTable_1.AutoContentTable("4", this, {
                testItem: this.testItem,
                autoItems: autoTestDataModels_1.initBrAutoData(),
        ...
        Button.onClick((event) => {
            ...
            //          if(BRInterface.testEnableBluetooth()){
            //            console.log(BRInterface.testEnableBluetooth())
            //            emitter.emit({ eventId: 1, priority: emitter.EventPriority.HIGH }
            //              , {data:{"message": BRInterface.testEnableBluetooth(), "id": "listitemclick0"}});
            //          }
            //
            //          message = BRInterface.testEnableBluetooth()  // 开蓝牙
            ...
            let Interface = autoTestDataModels_1.BrAutoTestCase.map(i => {
            ...
            //            brAutoTestMessage += BrAutoTestCase[index]["api"](...i.para) + "\n"
            ...
            async function forLoop() {
                for (let m = 0; m < Interface.length; m++) {
                    brAutoTestMessage += autoTestDataModels_1.BrAutoTestCase[m]["api"](...Interface[m].para) + "\n";
                    self.changeIndex = m;
                    await sleep(0.5);
                    AppStorage.SetOrCreate("brAutoTestMessage", brAutoTestMessage);
                }
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["commons"], () => (__webpack_require__("../../../../../../../../Documents/learning/Harmony/communication_bluetooth-master/test/example/bluetoothtest/entry/src/main/ets/MainAbility/pages/subAutoTest/brAutoTest.ets?entry")))
