...
/***/ "../../../../../../../../Documents/learning/Harmony/communication_bluetooth-master/test/example/bluetoothtest/entry/src/main/ets/MainAbility/pages/subAutoTest/subProfileAutoTest/a2dpSourceAutoTest.ets?entry":
/*!*********************************************************************************************************************************************************************************************************************!*\
  !*** ../../../../../../../../Documents/learning/Harmony/communication_bluetooth-master/test/example/bluetoothtest/entry/src/main/ets/MainAbility/pages/subAutoTest/subProfileAutoTest/a2dpSourceAutoTest.ets?entry ***!
  \*********************************************************************************************************************************************************************************************************************/
...
__webpack_require__(/*! ../../../model/a2dpSinkProfileInterface */ "../../../../../../../../Documents/learning/Harmony/communication_bluetooth-master/test/example/bluetoothtest/entry/src/main/ets/MainAbility/model/a2dpSinkProfileInterface.ets");
var _system_prompt_1  = isSystemplugin('prompt', 'system') ? globalThis.systemplugin.prompt : globalThis.requireNapi('prompt');
class A2dpSourceAutoTest extends View {
    constructor(compilerAssignedUniqueChildId, parent, params) {
        super(compilerAssignedUniqueChildId, parent);
        this.__message = new ObservedPropertySimple('A2dpSourceAutoTest', this, "message");
        ...
        this.__a2dpSourceProfileAutoTestMessage = AppStorage.GetOrCreate().setAndLink("a2dpSourceProfileAutoTestMessage", "", this);
    ...
    aboutToBeDeleted() {
        ...
        this.__a2dpSourceProfileAutoTestMessage.aboutToBeDeleted();
    ...
    get a2dpSourceProfileAutoTestMessage() {
        return this.__a2dpSourceProfileAutoTestMessage.get();
    }
    set a2dpSourceProfileAutoTestMessage(newValue) {
        this.__a2dpSourceProfileAutoTestMessage.set(newValue);
    }
    render() {
        Column.create();
        ...
        if (earlierCreatedChild_4 == undefined) {
            View.create(new autoContentTable_1.AutoContentTable("4", this, {
                testItem: this.testItem,
                autoItems: autoTestDataModels_1.initA2dpSourceProfileAutoData(),
        ...
        Button.onClick((event) => {
            ...
            let Interface = autoTestDataModels_1.A2dpSourceProfileAutoTestCase.map(i => {
            ...
            //            a2dpSourceProfileAutoTestMessage += A2dpSourceProfileAutoTestCase[index]["api"](...i.para) + "\n"
            //            sleep(0.5)//等500ms
            ...
            async function forLoop() {
                for (let m = 0; m < Interface.length; m++) {
                    a2dpSourceProfileAutoTestMessage += autoTestDataModels_1.A2dpSourceProfileAutoTestCase[m]["api"](...Interface[m].para) + "\n";
                    self.changeIndex = m;
                    await sleep(0.5);
                    AppStorage.SetOrCreate("a2dpSourceProfileAutoTestMessage", a2dpSourceProfileAutoTestMessage);
                }
...
loadDocument(new A2dpSourceAutoTest("1", undefined, {}));
...
/******/ 		var installedChunks = {
/******/ 			"./pages/subAutoTest/subProfileAutoTest/a2dpSourceAutoTest": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["commons"], () => (__webpack_require__("../../../../../../../../Documents/learning/Harmony/communication_bluetooth-master/test/example/bluetoothtest/entry/src/main/ets/MainAbility/pages/subAutoTest/subProfileAutoTest/a2dpSourceAutoTest.ets?entry")))
/******/ 	__webpack_exports__ = __webpack_require__.O(__webpack_exports__);
/******/ 	_78b3af9a3d4590e7047044e12e71f107 = __webpack_exports__;
/******/ 	
/******/ })()
;
//# sourceMappingURL=a2dpSourceAutoTest.js.map