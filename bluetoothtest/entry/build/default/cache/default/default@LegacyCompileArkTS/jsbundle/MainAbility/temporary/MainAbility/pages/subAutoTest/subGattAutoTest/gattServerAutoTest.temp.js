...
/***/ "../../../../../../../../Documents/learning/Harmony/communication_bluetooth-master/test/example/bluetoothtest/entry/src/main/ets/MainAbility/pages/subAutoTest/subGattAutoTest/gattServerAutoTest.ets?entry":
/*!******************************************************************************************************************************************************************************************************************!*\
  !*** ../../../../../../../../Documents/learning/Harmony/communication_bluetooth-master/test/example/bluetoothtest/entry/src/main/ets/MainAbility/pages/subAutoTest/subGattAutoTest/gattServerAutoTest.ets?entry ***!
  \******************************************************************************************************************************************************************************************************************/
...
__webpack_require__(/*! ../../../model/gattServerInterface */ "../../../../../../../../Documents/learning/Harmony/communication_bluetooth-master/test/example/bluetoothtest/entry/src/main/ets/MainAbility/model/gattServerInterface.ets");
var _system_prompt_1  = isSystemplugin('prompt', 'system') ? globalThis.systemplugin.prompt : globalThis.requireNapi('prompt');
class GattServerAutoTest extends View {
    constructor(compilerAssignedUniqueChildId, parent, params) {
        super(compilerAssignedUniqueChildId, parent);
        this.__message = new ObservedPropertySimple('GattServerAutoTest', this, "message");
        ...
        this.__gattServerAutoTestMessage = AppStorage.GetOrCreate().setAndLink("gattServerAutoTestMessage", "", this);
    ...
    aboutToBeDeleted() {
        ...
        this.__gattServerAutoTestMessage.aboutToBeDeleted();
    ...
    get gattServerAutoTestMessage() {
        return this.__gattServerAutoTestMessage.get();
    }
    set gattServerAutoTestMessage(newValue) {
        this.__gattServerAutoTestMessage.set(newValue);
    }
    aboutToAppear() {
    ...
    render() {
        ...
        if (earlierCreatedChild_4 == undefined) {
            View.create(new autoContentTable_1.AutoContentTable("4", this, {
                testItem: this.testItem,
                autoItems: autoTestDataModels_1.initGattServerAutoData(),
        ...
        Button.onClick((event) => {
            ...
            let Interface = autoTestDataModels_1.GattServerAutoTestCase.map(i => {
            ...
            async function forLoop() {
                for (let m = 0; m < Interface.length; m++) {
                    gattServerAutoTestMessage += autoTestDataModels_1.GattServerAutoTestCase[m]["api"](...Interface[m].para) + "\n";
                    self.changeIndex = m;
                    await sleep(0.5);
                    AppStorage.SetOrCreate("gattServerAutoTestMessage", gattServerAutoTestMessage);
                }
...
loadDocument(new GattServerAutoTest("1", undefined, {}));
...
/******/ 		var installedChunks = {
/******/ 			"./pages/subAutoTest/subGattAutoTest/gattServerAutoTest": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["commons"], () => (__webpack_require__("../../../../../../../../Documents/learning/Harmony/communication_bluetooth-master/test/example/bluetoothtest/entry/src/main/ets/MainAbility/pages/subAutoTest/subGattAutoTest/gattServerAutoTest.ets?entry")))
/******/ 	__webpack_exports__ = __webpack_require__.O(__webpack_exports__);
/******/ 	_78b3af9a3d4590e7047044e12e71f107 = __webpack_exports__;
/******/ 	
/******/ })()
;
//# sourceMappingURL=gattServerAutoTest.js.map